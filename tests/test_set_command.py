...
class SetCommandTest(CommandTest):
    ...
    def test_set(self):
        ...
        before2 = 'file2.txt'
        before3 = 'file3{t2}{t4}.txt'
        after1 = 'file1{t2}{t4}.txt'
        after2 = 'file2{t2}{t4}.txt'
        after3 = 'file3{t2}{t4}.txt'
        self.run_command_test(
            command = f'set --verbose t2,t4 {before1} {before2} {before3}',
